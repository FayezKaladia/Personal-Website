...
export const defaultPortfolioData: PortfolioData = {
  ...
  education: [
    {
      ...
      institution: "M.H. Saboo Siddik College of Engineering (MHSSCOE)",
      location: "India",
      period: "Currently Pursuing",
      description: "Specializing in Artificial Intelligence and Machine Learning",
      highlights: [
        "Building expertise in Deep Learning, NLP, and Computer Vision",
        "Developing real-world AI and software-based projects",
        "Strengthening research, analytical, and problem-solving skills",
      ],
    },
    {
      id: "edu-2",
      degree: "Diploma in Artificial Intelligence & Machine Learning",
      institution: "M.H. Saboo Siddik Polytechnic (MHSSP)",
      location: "India",
      period: "2023 - 2025",
      grade: "Rank 1 in Class",
      description: "Comprehensive foundation in AI/ML fundamentals and practical applications",
      highlights: [
        "Awarded Medalist in AI & ML specialization",
        "Developed multiple AI and software development projects",
        "Built strong foundation in Python, Machine Learning, and data processing",
        "Gained practical experience in model development and deployment basics",
      ],
    },
    {
      id: "edu-3",
      ...
      location: "India",
      period: "2021 - 2023",
      description: "Physics, Chemistry, Mathematics, and Biology specialization",
      highlights: [
        "Completed 11th & 12th with Physics, Chemistry, Mathematics, and Biology",
        "Prepared for national competitive exams including JEE and CET",
        "Developed strong analytical, logical reasoning, and scientific fundamentals",
      ],
    },
    {
      id: "edu-4",
      degree: "Secondary School Education (ICSE)",
      institution: "Christ Church School",
      location: "India",
      period: "2021 Onwards",
      description: "Strong academic foundation in core subjects",
      highlights: [
        "Built strong academic foundation in Mathematics, Science, and English",
        "Developed communication, presentation, and critical thinking skills",
        "Strengthened discipline and structured learning approach",
      ],
    },
  ],
  skills: [
  ...
  projects: [
    {
      id: "proj-1",
      title: "AI-Powered College Chatbot – College Connect",
      description: "Developed an AI chatbot to automate college admission queries and improve student–administration communication. Provides instant responses, interactive campus map, gallery section, FAQ support, and aptitude test module. Designed to reduce administrative workload and improve onboarding experience for new students.",
      technologies: ["Gemini API", "Python", "Flask", "HTML", "CSS", "JavaScript"],
      githubUrl: "https://github.com/FayezKaladia/CollegeConnect",
      featured: true,
    },
    {
      id: "proj-2",
      title: "AI Legal Assistance System – LegalEase",
      description: "Built an AI-based legal support platform to simplify understanding of Indian laws for general users. Features document analysis, AI chatbot guidance, legal case drafting assistance, and multilingual support. Includes speech and audio interaction to improve accessibility for underprivileged and less-educated users.",
      technologies: ["Python", "NLP Models", "Gemini API", "FastAPI", "JavaScript"],
      githubUrl: "https://github.com/FayezKaladia/Final-LE-",
      featured: false,
    },
    {
      id: "proj-3",
      title: "Anonymous Feedback Management System – OpenVoice",
      description: "Created a secure and anonymous feedback collection system for educational institutions. Generates trackable tickets for user complaints and allows administrators to monitor and resolve issues in real time. Enhances transparency and encourages open communication while protecting user identity.",
      technologies: ["Python", "Flask", "MySQL", "HTML", "CSS", "JavaScript"],
      githubUrl: "https://github.com/FayezKaladia/campus-connect",
      featured: false,
    },
    {
      id: "proj-4",
      title: "Legal Support Networking Platform – LegalBridge",
      description: "Designed a social impact platform connecting lawyers, paralegals, and legal experts with underprivileged communities. Enables affordable or pro bono legal consultation, especially for rural and economically weaker populations. Extends LegalEase by creating a collaborative legal assistance ecosystem.",
      technologies: ["Python", "React.js", "Node.js", "MongoDB", "REST APIs"],
      githubUrl: "https://github.com/FayezKaladia/LegalBridge",
      featured: false,
    },
    {
      id: "proj-5",
      title: "AI-Based Smart Traffic & Parking Management System",
      description: "Developing an AI-driven traffic control system for real-time congestion monitoring and automated signal optimization. Supports multi-signal network integration to improve urban traffic flow and reduce congestion. Designed for smart city deployment under Solapur Municipal Corporation hackathon initiative.",
      technologies: ["Python", "OpenCV", "YOLO", "TensorFlow", "IoT Integration"],
      githubUrl: "",
      featured: false,
    },
    {
      ...
      description: "Additional projects and case studies will be added here — stay tuned.",
      technologies: [],
      githubUrl: "",
      featured: false,
    },
